...
const SelectFolder: FC<ISelectFolder> = () => {
  return (
    <div className="folder__container">
      <Container maxW={"container.lg"}>
        {/* <button
        onClick={() => {
          (window as any).api.send("setFolderSongs");
        }}
      >
        select folder
      </button> */}
	...
	c0,18.237-2.091,36.399-6.217,53.999v93.864C485.675,421.13,481.856,424.95,477.142,424.95z"
        ...
        <h1>Benvenuto!</h1>
        <p className="m-0">Con questo software puoi scaricare video da youtube, convertirli in mp3 e salvarli in un apposita cartella nel tuo pc.</p>
        <p className="m-0">Oltre a ciò è incluso un semplice audio player per l'ascolto di tutte le canzoni dedicate</p>
        <p className="m-0">Per funzionare questo software ha bisogno di una cartella su cui salvare i file</p>
        <div className="d-flex justify-content-center mt-4">
            <CustomButton label="SELEZIONA" 
              onClick={() => {
                (window as any).api.send("setFolderSongs");
              }}
            />
